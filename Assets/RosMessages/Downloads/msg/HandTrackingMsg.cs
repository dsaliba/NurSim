...
{
    [Serializable]
    public class HandTrackingMsg : Message
    {
        public const string k_RosMessageName = "Downloads/HandTracking";
        ...
        public HandTrackingMsg(float pos_x, float pos_y, float pos_z, float rot_x, float rot_y, float rot_z, float rot_w)
        {
            this.pos_x = pos_x;
            this.pos_y = pos_y;
            this.pos_z = pos_z;
        ...
        public static HandTrackingMsg Deserialize(MessageDeserializer deserializer) => new HandTrackingMsg(deserializer);

        private HandTrackingMsg(MessageDeserializer deserializer)
        {
